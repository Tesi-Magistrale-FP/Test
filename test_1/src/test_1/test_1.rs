...
// Funzione per misurare il tempo necessario per attaccare delle transazioni semplici al Tangle su una rete specifica
#[allow(unused_must_use)]
pub async fn test(coordinate: Vec<String>, node_url: String, path_ris: String) -> Result<()>
{
